...
class LoadData():
    def __init__(self, data_path=None, dataset_name="ML1M"):
...
class HDF5_Dataset(Dataset):
    def __init__(self, 
                 items: pd.DataFrame, 
                 targets: pd.DataFrame, 
                 file_path: str = "../semantic_hdf5/ml1m_hdf5_embeddings/semantic_representations_llama_1B_last_mean_pool.npy"):
        self.items = items 
        self.targets = targets
...
def ml1m_dataloader_train(batch_size=128, file_path=None, num_workers=4, tokenzier=None, type = "hdf5"):
    # In this file, we have saved the items, targets, sentences, and field_dims. Sentences is the textual modality.
    path = "./LLM_CTR_ML1M_data.p"  
...
if __name__ == '__main__':
    ...
    fields, train_loader, valid_loader, test_loader = ml1m_dataloader_train(batch_size=128, type="base")
    print(fields)
    print(sum([6040, 3706, 2, 7, 21, 3439, 3664, 81, 301])) # 17261 
