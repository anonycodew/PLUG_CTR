...
from model.BasicLayer import BasicCTRLLM, FeaturesLinear, FeaturesEmbedding, CrossNetworkV2, MultiLayerPerceptron
from torch import Tensor

class CNv2(BasicCTRLLM):
    def __init__(self, field_dims, embed_dim=16, 
        ...
        self.feature_interaction_encoder = CrossNetworkV2(self.embed_output_dim, cross_layers)
...
class DCNv2(BasicCTRLLM):
    def __init__(self, field_dims, embed_dim=16, 
        ...
        self.feature_interaction_encoder = CrossNetworkV2(self.embed_output_dim, 
                                                        cross_layers)
...
class DCNv2_PLUG(BasicCTRLLM):
    def __init__(self, field_dims, embed_dim=16, 
        ...
        self.output_layer = nn.Linear(mlp_layers[-1] + self.embed_output_dim, 1)        
        self.tabular_feature_dimension = self.embed_output_dim + mlp_layers[-1]
