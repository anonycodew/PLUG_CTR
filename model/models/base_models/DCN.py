...
from model.BasicLayer import BasicCTRLLM, FeaturesLinear, FeaturesEmbedding, CrossNetwork, MultiLayerPerceptron
from torch import Tensor

class CNv1(BasicCTRLLM):
    def __init__(self, field_dims, embed_dim=16, 
        ...
        self.feature_interaction_encoder = CrossNetwork(self.embed_output_dim, cross_layers)
...
class DCNv1(BasicCTRLLM):
    def __init__(self, field_dims, embed_dim=16, 
        ...
        self.feature_interaction_encoder = CrossNetwork(self.embed_output_dim, 
                                                        cross_layers)
